...
if (visibleBadges.length < visibleCount) {
  visibleBadges.push(
    ...badges.slice(0, visibleCount - visibleBadges.length)
  );
}
...
const totalUsersCount = mergedBadges.reduce((sum, badge) => sum + (badge.userCount || 0), 0);
...
return (
  <div className="p-4 md:p-8 bg-gray-50 max-w-6xl mx-auto">
