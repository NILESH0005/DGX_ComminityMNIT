            ...
            {isTyping && (
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <ul className="space-y-1 text-sm">
                  <li
                    className={`flex items-center ${messages.length ? "text-green-500" : "text-red-500"}`}
                  >
                    {messages.length ? "✓" : "✗"} At least 8 characters
                  </li>
                  <li
                    className={`flex items-center ${messages.number ? "text-green-500" : "text-red-500"}`}
                  >
                    {messages.number ? "✓" : "✗"} At least one number
                  </li>
                  <li
                    className={`flex items-center ${messages.specialChar ? "text-green-500" : "text-red-500"}`}
                  >
                    {messages.specialChar ? "✓" : "✗"} At least one special
                    character
                  </li>
                  <li
                    className={`flex items-center ${messages.uppercase ? "text-green-500" : "text-red-500"}`}
                  >
                    {messages.uppercase ? "✓" : "✗"} At least one uppercase
                    letter
                  </li>
                  <li
                    className={`flex items-center ${messages.lowercase ? "text-green-500" : "text-red-500"}`}
                  >
                    {messages.lowercase ? "✓" : "✗"} At least one lowercase
                    letter
                  </li>
                </ul>
              </div>
